...
func (r *TodoListPostgres) Create(userId int, list rest_api.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetById(userId int, listId int) (rest_api.TodoList, error) {
	var list rest_api.TodoList
...
func (r *TodoListPostgres) Update(userId int, listId int, input rest_api.UpdateListInput) error {
